...
/**
 * Test the SmartEnumJobOptimizer
 * 
 * @author hero
 */
public class TestSmartEnumJobOptimizer extends TestCase {
	...
	public void testWhatIfJobConfGetTime() {
		...
		tsConf.setBoolean(SmartEnumJobOptimizer.USE_RANDOM_VALUES, false);
		...
		// Find the best configuration
		wcConf.setBoolean(SmartEnumJobOptimizer.USE_RANDOM_VALUES, false);
