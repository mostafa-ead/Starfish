 ...
 * @author hero
 */
public class TestFullEnumJobOptimizer extends TestCase {
	...
	public void testWhatIfJobConfGetTime() {
		...
		FullEnumJobOptimizer tsOptimizer = new FullEnumJobOptimizer(tsOracle,
		...
		FullEnumJobOptimizer wcOptimizer = new FullEnumJobOptimizer(wcOracle,
