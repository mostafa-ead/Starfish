 ...
 * @author hero
 */
public class TestSmartRRSJobOptimizer extends TestCase {
	...
	public void testWhatIfJobConfGetTime() {
		...
		assertNotNull(tsBestConf.getFloat(Constants.MR_SORT_REC_PERC, 0));
		assertNotNull(tsBestConf.getInt(Constants.MR_SORT_FACTOR, 0));
		assertNotNull(tsBestConf.getInt(Constants.MR_RED_TASKS, 0));
		assertNotNull(tsBestConf.getInt(Constants.MR_INMEM_MERGE, 0));
		assertNotNull(tsBestConf.getFloat(Constants.MR_SHUFFLE_IN_BUFF_PERC, 0));
		assertNotNull(tsBestConf.getFloat(Constants.MR_SHUFFLE_MERGE_PERC, 0));
