...
/**
 * Represents information about a Pig Job, containing Map-Reduce jobs.
 * 
 * @author hero
 * 
 */
public class PigJobInfo extends JobInfo {
	...
	/**
	 * @return the Map-Reduce jobs comprising this Pig job
	 */
	...
	public String toString() {
		return "PigJobInfo [ID=" + getExecId() + ", Name=" + getName()
